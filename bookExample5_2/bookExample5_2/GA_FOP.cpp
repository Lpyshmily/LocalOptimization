...
int GA_FOP(double* Out, const double* rv0, const double* rv1, double m0, double tof, double epsi, int MaxGuessNum, const double* rv_middle, double PSO_t)
{
	...
	while (num<MaxGuessNum)
	{
		...
		*/
		...
		// epsi=2.343749999831972e-008,16021.641737147094000,fail
...
int GA_FOP_type1(double* Out, const double* rv0, const double* rv1, double m0, double tof, int MaxGuessNum, const double* rv_middle, double PSO_t)
{
	...
	// 二次同伦 epsi = 3e-6,fail
	x[0] = 8.154177045817636e-001;
	x[1] = -2.142127675176473e-001;
	x[2] = -2.973380854267797e-001;
	x[3] = -3.209968535727250e-002;
	x[4] = 2.825152644417415e-001;
	x[5] = -2.108108178050005e-001;
	x[6] = -8.496451879268449e-002;
	x[7] = 1.781258899236253e-001;
	x[8] = 2.547790157926978e-002;
	x[9] = -5.913150865109100e-002;
	x[10] = 7.656859578497770e-002;
	x[11] = -1.616652487111299e-001;
	x[12] = 2.045950867522520e-002;
	x[13] = 6.410221342827968e-002;
	x[14] = 9.068710103142272e-002;
	x[15] = -1.831536130328857e-003;
	x[16] = 3.878669878099160e-001;

	// 二次同伦 epsi = 8.3628E-11,fail
	x[0] = 8.154177046527950e-001;
	x[1] = -2.142127674538505e-001;
	x[2] = -2.973380853422543e-001;
	x[3] = -3.209968531263017e-002;
	x[4] = 2.825152643674194e-001;
	x[5] = -2.108108177467262e-001;
	x[6] = -8.496451879660789e-002;
	x[7] = 1.781258899389622e-001;
	x[8] = 2.547790162878266e-002;
	x[9] = -5.913150863168866e-002;
	x[10] = 7.656859579370122e-002;
	x[11] = -1.616652487828329e-001;
	x[12] = 2.045950868275564e-002;
	x[13] = 6.410221337966267e-002;
	x[14] = 9.068710106294113e-002;
	x[15] = -1.831536125525822e-003;
	x[16] = 3.878669878283090e-001;

	// 二次同伦 epsi=0.0,16021.641904625276000
	x[0] = 8.154177046475694e-001;
	x[1] = -2.142127674389824e-001;
	x[2] = -2.973380853411576e-001;
	x[3] = -3.209968530189182e-002;
	x[4] = 2.825152643492014e-001;
	x[5] = -2.108108177474056e-001;
	x[6] = -8.496451879458791e-002;
	x[7] = 1.781258899585809e-001;
	x[8] = 2.547790164264472e-002;
	x[9] = -5.913150864025732e-002;
	x[10] = 7.656859580093177e-002;
	x[11] = -1.616652488344341e-001;
	x[12] = 2.045950868480233e-002;
	x[13] = 6.410221336065319e-002;
	x[14] = 9.068710107552760e-002;
	x[15] = -1.831536123345039e-003;
	x[16] = 3.878669878326835e-001;
	*/
...
int GA_FOP_type2(double* Out, const double* rv0, const double* rv1, double m0, double tof, double epsi, int MaxGuessNum, const double* rv_middle, double PSO_t)
{
	...
	while (num<MaxGuessNum)
	{
		...
		*/
		...
		// epsi = 3e-6,16021.641903042590000
		x[0] = 8.154177045817636e-001;
		x[1] = -2.142127675176473e-001;
		x[2] = -2.973380854267797e-001;
		x[3] = -3.209968535727250e-002;
		...
		// epsi=0.000000000083628,16021.641903582040000,1e-3
		x[0] = 8.154177046527950e-001;
		x[1] = -2.142127674538505e-001;
		x[2] = -2.973380853422543e-001;
		x[3] = -3.209968531263017e-002;
		...
		x[16] = 3.878669878283090e-001;
		*/
		// epsi=0.0,16021.641904625276000
		x[0] = 8.154177046475694e-001;
		x[1] = -2.142127674389824e-001;
		x[2] = -2.973380853411576e-001;
		x[3] = -3.209968530189182e-002;
...
int change_epsi_type2(double* Out, const double* rv0, const double* rv1, double m0, double tof, int MaxGuessNum, const double* rv_middle, double PSO_t)
{
	...
	flag = GA_FOP_type2_process(Out, rv0, rv1, m0, tof, 0.0, MaxGuessNum, rv_middle, PSO_t);
	return flag;
}