...
{
	double x, rv0[6], rv1[6], rv_middle[6];
	x = *px;
	V_Copy(rv0, para, 6);
	V_Copy(rv1, &para[6], 6);
	...
	int flag;
	double rv_t[6] = {0.0};
	rv02rvf(flag, rv_t, rv_middle, MJD_MARS*86400/TUnit, middle_t*86400/TUnit, muNU);
...
double GA_PSO(const double* rv0, const double* rv1, const double* rv_middle, int psotime)
{
	double sfpara[18];
	V_Copy(sfpara, rv0, 6);
